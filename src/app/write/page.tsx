...
//       try {
//         const collabParam = searchParams.get('noCollab');
//         setHasCollab(parseInt(collabParam as string) !== 1);
...
//   if (hasCollab && (!collabToken || !provider)) return null; // Render nothing until the provider is ready
