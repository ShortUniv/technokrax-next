    ...
    <div className="relative">
      <div
        className={`fixed inset-0 bg-black opacity-10 z-10 ${
          commentsActive ? "" : "hidden"
        }`}
      ></div>
      <div
        className={`fixed top-0 right-0 ${
          commentsActive ? "" : "translate-x-full"
        } transition-transform duration-700 ease-in-out z-20 w-[80%] sm:w-[50%] lg:w-[40%] xl:w-[27%] h-full bg-[#FFFFFF] shadow-lg p-6 overflow-y-scroll`}
      >
            ...
            <div key={index} className="mt-4">
              <div className="flex gap-8">
                ...
                <div>
                  ...
                  <Link href={`/profile/${data?.userId}`}>
              <p className="text-[14px] text-[#242424] hover:underline">
                {data.name}
              </p>
            </Link>
