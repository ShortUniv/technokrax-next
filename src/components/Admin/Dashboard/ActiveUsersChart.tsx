...
const ActiveUsersChart = () => {
  const chartContainer = useRef<HTMLDivElement>(null); // Use explicit typing for ref
  const [percentageChange, setPercentageChange] = useState<number | null>(null); // Use explicit typing for state variables
  const [trendIcon, setTrendIcon] = useState<any>(null); // Use explicit typing for state variables
  const [trendColor, setTrendColor] = useState<any>(null); // Use explicit typing for state variables
